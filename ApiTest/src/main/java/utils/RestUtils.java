...
public class RestUtils {
    ...
    */
    public static ResponseOptions<Response> setBaseURI(String baseURI) {
        try {
           ...
           // System.out.println("Server Loaded : " + baseURI);
        } catch (Exception e) {
            System.out.println("Exception : setBaseURI : FAILED TO LOAD SERVER/URI LINK");
        }
        return null;
    }
    ...
    */
    ...
    public String getIdOfLastRecord(String lastRecord)
    {
        String indexOfRecord = lastRecord.trim();
        String lastRecordID = indexOfRecord.substring(indexOfRecord.lastIndexOf(' ') + 1);
        System.out.println("\n" + " *** LAST RECORD ON THE DATABASE : " + lastRecordID);
        return lastRecordID;
    }
